...
public class GuiChangeARGB extends GuiScreen implements ISliderUpdate {
    ...
    public void initGui() {
        ...
        //sliders init
        this.redIntSlider = new SliderCompact(2, offsetX, offsetY, translate.translateKeyFormat("epsilon.red", this.red), this.red / 255.0F);
        this.greenIntSlider = new SliderCompact(3, offsetX, offsetY + 30, translate.translateKeyFormat("epsilon.green", this.green), this.green / 255.0F);
        this.blueIntSlider = new SliderCompact(4, offsetX, offsetY + 60, translate.translateKeyFormat("epsilon.blue", this.blue), this.blue / 255.0F);
        this.alphaIntSlider = new SliderCompact(5, offsetX, offsetY + 90, translate.translateKeyFormat("epsilon.alpha", this.alpha), this.alpha / 255.0F);
